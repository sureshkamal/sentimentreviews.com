                    ...
                    <table class="table border mb-0">
                      ...
                      <tbody>
                        ...
                        <tr class="align-middle">
                          ...
                          <td>
                            <div>{{ $store->store_slug }}</div>
                          </td>
                          <td class="">
                            <div>{{ $store->store_admin_email }}</div>
                          </td>
                          <td>
                            <div>123123</div>
                          ...
                          <td class="text-center">
                            <a href="/admin/create-branch"> Create Branch </a>
                          </td>
                          <td class="text-center">
                            <a href="/admin/view-branches"> View Branches </a>
                          </td>
                        </tr>
                        @endforeach
